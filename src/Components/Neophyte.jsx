              ...
              <div class="box-neometry-1">
                <div className="box-neometry-1-inner">
                  ...
                  <p className="box-text-subtitle">
                    Neophyte has provided warehouse solutions to over 10 clients
          ...
          <div className="neomet-second-right-cards">
                  ...
                  <div class="box-neometry-2">
                    <div className="box-neometry-2-inner">
                      ...
                      <p className="box-text-subtitle-2">
                        ...
                        Warehouse solutions to over 10 clients across different
                        industries
                      </p>
                    </div>
                  </div>
            ...
            <div className="explore-next-div">
              <p className="explore-more-txt">
                Explore more <BsArrowRightCircle size={22} />
              </p>
            </div>
          </div>
        </Col>
